...
available_opponents = [
    ...
    {"name": "DQN Convolution", "size": 3, "key": "dqn3conv"},
    {"name": "DQN", "size": 3, "key": "dqn3"},
    {"name": "DQN(legacy)", "size": 3, "key": "dqn3legacy"},
...
opponent_classes = {
    ...
    "dqn3conv": player.DQNPlayer('DQNPlayer3', model=model.DQNConv.load('dqnconv_3_greedy_94_greedy')),
